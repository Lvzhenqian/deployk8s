...
from .Loger import DEBUG,INFO,getLogger,file_hand
import paramiko,sys,select,os
from stat import S_ISDIR

class SSH(object):
    def __init__(self, host, port, user, passwd, pKey=None, keypass=None):
    ...
    def runner(self, command, timeout=3600):
        ...
        self.logger.debug("{address}: {cmd}".format(address=self.address[0], cmd=command))
